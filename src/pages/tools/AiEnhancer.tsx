...
const AiEnhancer = () => {
  ...
  const handleEnhance = async () => {
    ...
    try {
      ...
      // Apply AI enhancement transformations
      const processedUrl = result.secure_url.replace(
        '/upload/',
        '/upload/e_enhance,e_improve,q_auto:best/'
      );
  ...
  return (
    <ToolLayout
      ...
      description="Enhance your images automatically using advanced AI algorithms"
    >
      <div className="space-y-8">
        ...
        {status === 'completed' && resultUrl && (
          <div className="text-center space-y-4">
            <p className="text-green-500 mb-4">Image enhanced successfully!</p>
